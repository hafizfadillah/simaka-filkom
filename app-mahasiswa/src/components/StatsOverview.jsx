...
const StatsOverview = ({ totalMahasiswa, activePercent, totalProdi }) => {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <motion.div
        className="premium-card p-8 rounded-2xl shadow-xl flex items-center justify-between group hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-500 border border-white/5"
        custom={0}
        initial="hidden"
        animate="visible"
      ...
      >
        <div>
          ...
          <h3 className="text-5xl font-black text-on-surface glow-text">{animatedTotal}</h3>
        </div>
      ...
      <motion.div
        className="premium-card-primary p-8 rounded-2xl shadow-[0_20px_50px_rgba(37,99,235,0.3)] flex items-center justify-between text-white relative overflow-hidden group hover:shadow-[0_25px_60px_rgba(37,99,235,0.4)] transition-all duration-500"
        custom={1}
        initial="hidden"
        animate="visible"
        variants={cardVariants}
      >
        <div className="z-10">
          ...
          <h3 className="text-5xl font-black text-white glow-text drop-shadow-lg">{activePercent}</h3>
        </div>
      ...
      >
        <div>
          ...
          <h3 className="text-5xl font-black text-on-surface glow-text">{animatedProdi}</h3>
        </div>
        <div className="w-16 h-16 bg-primary/10 dark:bg-primary-container/30 rounded-2xl flex items-center justify-center text-primary group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 border border-primary/5 dark:border-white/5">
